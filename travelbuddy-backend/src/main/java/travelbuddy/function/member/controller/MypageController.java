...
//    @Operation(summary = "게시글상세조회요청", description = "내가쓴글상세보기및 신청회원리스트", tags = {"MypageController"})
//    @GetMapping("/mybuddypost/{buddyCode}")
//    public ResponseEntity<ResponseDTO> selectMypagePostDetail(@PathVariable int buddyCode) {
//        return ResponseEntity.ok().body(new ResponseDTO(HttpStatus.OK, "내가쓴글상세조회성공", mypageService.selectMypagePostDetail(buddyCode)));
//    }
