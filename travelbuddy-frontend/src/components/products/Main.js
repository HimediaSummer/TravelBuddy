        ...
        <body>
            ...
            <main class="wrap">
                ...
                <div class="subtitle">
					...
					<button type='button' id='button' onClick={() => window.location.href=`http://${process.env.REACT_APP_RESTAPI_IP}:80/schedule`} style={{position: 'absolute', top: '80%', left: '20%', transform: 'translate(-50%, -50%)', padding: '10px 20px', zindex:20, cursor: 'pointer' }}>시작하기</button>
            </div>
			<br/>
			<hr/>
			<div class="intro">
